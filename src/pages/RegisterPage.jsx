...
import { registerSchema, validateWithZod } from "../lib/validators";
...
export default function RegisterPage() {
  ...
  async function handleSubmit(event) {
    ...
    const validation = validateWithZod(registerSchema, formData);
  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center px-4 py-12">
      ...
      >
        ...
        <p className="mt-2 text-slate-600">Start shopping with Hiigso.</p>
